...
sec_hand=pygame.image.load(r'lefthand1.png')
image=pygame.image.load(r'back.png')
hand=pygame.image.load(r'righthand1.png')
...
print(hand.get_width(), hand.get_height())
